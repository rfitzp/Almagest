...
motion  of an inferior planet (that is, a planet which is closer to the Sun than the Earth), $P$,  as seen from the Earth, $G$. The Sun is
at $S$.
...
\begin{figure}[h]
\centerline{\includegraphics[height=2.75in]{epsfiles/fig8.eps}}
...
As before, the information contained in the mean motion tables, \ref{vt17}  and \ref{vt20}, is essentially equivalent to that contained in the tables
that appear in Section~4 of Book~IX of the Almagest. Likewise, the information contained in the anomaly tables, \ref{vt18}  and \ref{vt21}, is equivalent
to that contained in the tables that appear in Section~11 of Book~XI of the Almagest. The computation of the greatest elongations of the inferior planets is
