...
such as Pythagoras (Πυθαγόρας) and his school, Eudoxos of Cnidus (\begin{greek}Εὔδοξος ὁ Κνίδιος\end{greek}), and Theaetetus of Athens (\begin{greek}Θεαίτητος ὁ Ἀθηναῖος\end{greek}). However, Euclid is credited with arranging the theorems 
...
the Moon, and the five visible (to the naked eye) planets in the Earth's sky.  On the basis of his own naked-eye observations, combined with those of earlier astronomers such as Hipparchus of Nicaea (\begin{greek}Ἱππάρχος ὁ Νικαεύς\end{greek}), Ptolemy proposed  a model of the Solar System in which the Earth is stationary.
