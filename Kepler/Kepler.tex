...
According to Kepler's first law, all planetary orbits are {\em ellipses}\/  tjat are {\em confocal}\/ with the Sun and lie in a
fixed plane.
...
\begin{figure}[h]
\centerline{\includegraphics[height=2.5in]{epsfiles/fig1.eps}}
...
of the mean anomaly, which is a  linear unction of time, by the
...
\cos T &= \frac{\cos E - e}{1-e\,\cos E}.
\end{align}
It turns out that the Earth and the five visible (to the naked eye) planets all possess  low eccentricity orbits characterized by $e\ll 1$. Hence, it is a good approximation to expand the previous three equations
...
Hipparchus' geometric model of the apparent orbit of the Sun around the Earth can also be used to describe a heliocentric planetary orbit. The model is illustrated  in Figure~\ref{hipp}. The orbit of the planet corresponds
...
\begin{figure}[h]
\centerline{\includegraphics[height=3in]{epsfiles/hipp1.eps}}
...
is greater by a factor of $2$ in the former model), whereas 
 the true anomaly, $T$,  only deviates  to  second order  in $e$.  We conclude that  Hipparchus' geometric model
...
\begin{figure}[h]
\centerline{\includegraphics[height=3in]{epsfiles/ptol1.eps}}
...
more accurate than  Hipparchus' model, because the 
...
Copernicus' geometric model of  a heliocentric planetary orbit is illustrated  in Figure~\ref{cop}. 
...
\begin{figure}[h]
\centerline{\includegraphics[height=3in]{epsfiles/cop1.eps}}
...
relative radial distance, $r/a$,  and the true anomaly, $T$, in Copernicus' geometric model of a heliocentric planetary orbit only deviate from those in the (correct) Keplerian model to  second-order  in $e$. However, the deviation  in the Ptolemaic
