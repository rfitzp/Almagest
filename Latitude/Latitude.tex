...
In the following, we shall outline a model that is capable of predicting these values.
...
Incidentally, the calculation of planetary latitudes is discussed in Book~XIII of the Almagest. 
