# Script to evaluate parallax of Moon
...
for t in range (13):
    ...
    if alt > -1.e-8:
        ...
        dbm = - dap * math.sin (mum)
        
        print ("%02d:%02d  %02d°%02d′  %03d°%02d′  %03d°%02d′ %2.0f′ %+3.0f′ %+3.0f′ %+3.0f′ %+3.0f′"
               % (t, 0, altd, altm, mupd, mupm, mumd, mumm, dap, dlp, dbp, dlm, dbm))
