...
the planet's (approximately) circular motion around the Sun, and the Earth's
 ...
 data very well, only contains 12circles (that is, 6 deferents and 6 epicycles). (There are 6 epicycles because Mercury possesses an additional
 spurious epicycle.) The additional common tale that medieval astronomers added more and more epicycles to Ptolemy's model in a
...
In summary, Copernicus's model of the Solar System contains  the 
 same number of epicycles as Ptolemy's, the only difference being that Copernicus's epicycles are much 
