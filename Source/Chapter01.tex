...
and the superlative form of the adjective, μεγίστη,  with the Arabic article ``al" prepended, lies behind the Arabic name from which the English name Almagest derives.} of Claudius Ptolemy (Κλαύδιος Πτολεμαῖος), 
...
\section{Ptolemy's model of the Solar System}
 ...
 knowledge of geometry and arithmetic acquired by the civilization of ancient Greece. Ptolemy
  also inherited an extensive Babylonian and ancient Greek body of knowledge concering observational and theoretical astronomy. The most important astronomer
 prior to Ptolemy was undoubtedly Hipparchus of Nicaea (second century BC), who produced the first circular chord table (which is key to Ptolemy's trigonometry), developed the theory of solar motion used by Ptolemy, discovered
 ...
 of Alexandria (Μενέλαος ὁ Ἀλεξανδρεύς, 1st century AD).
...
the planet's (approximately) circular motion around the Sun, and the Earth's
 ...
 data very well, only contains 10 circles (that is, 4 deferents and 6 epicycles). (There are 4 deferents because the deferents of the Sun, Mercury and Venus are identical, 
 and 6 epicycles because Mercury possesses an additional
...
\begin{figure}
\centerline{\includegraphics[height=2.5in]{Fig1-1.eps}}
...
In summary, Copernicus's model of the Solar System contains  the 
 same number of circles as Ptolemy's, the only difference being that Copernicus's epicycles are much 
 smaller than Ptolemy's.  Indeed, the model of Copernicus is about as complicated, and not appreciably more accurate (except in the case of the Moon), than that described in the  Almagest. 
...
\begin{figure}[t]
\centerline{\includegraphics[height=2.5in]{Fig1-2.eps}}
