...
with viewing the same celestial object from different observation sites on the surface of the Earth.\footnote{
 ...
 that its diurnal parallax is significant. See Section~\ref{spara}.}
...
uniformly from east to west once every 24 (sidereal) hours, about a fixed axis passing through the Earth's north and south geographic  poles. This type of motion is called  {\em diurnal motion}\/ (from the Latin {\em dies}, meaning ``day''), and is a consequence of the Earth's daily  rotation. Diurnal motion preserves the relative angular positions of all celestial objects. However, certain
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-1.eps}}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-2.eps}}
...
range 0  to 24 hours. (Incidentally, in this book, $\alpha$ is measured
relative to the mean equinox at date, unless otherwise specified.)
Finally, let ${\bf r}$ be a unit vector that is directed from the Earth to $R$. See Figure~\ref{f2}. It is easily
demonstrated that 
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-3.eps}}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-4.eps}}
...
around the ecliptic). (Again, in this book, $\lambda$ is measured relative
...
of these stars that lie within $10^\circ$ of the ecliptic. The figure and the table can
be used 
 to convert ecliptic longitude and latitude into approximate position
in the sky against the backdrop of the fixed stars.

Figure~\ref{map2}  and   Table~\ref{tstar}  contain more or less the same information  as that contained in Section~5 of Book VII of the Almagest
...
\section{The signs of the zodiac}\label{szod}
...
See Figure~\ref{map2}. (Incidentally, Ptolemy was well aware of this fact because, even in his day, the signs of the zodiac did not coincide with the constellations. The signs coincided with the constellations in the time of the ancient Mesopotamians; that is, about 1500 BC.)
...
Table~\ref{tec2}, which  lists the declinations and right ascensions of a set of equally spaced points on the ecliptic circle.
Note that $\lambda$ is measured relative to the start of the appropriate zodiacal sign. 

 Table~\ref{tec2}  contains essentially the same information
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-5.eps}}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-6.eps}}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-7.eps}}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-8.eps}}
...
{\bf n} &= -\sin L\,\cos \alpha_0\,{\bf v} + (\cos L\,\sin \epsilon-\sin L\,\cos \epsilon\,\sin \alpha_0)\,{\bf s}\nonumber\\[0.5ex]
&\phantom{=} + (\cos L\,\cos \epsilon+\sin L\,\sin \epsilon\,\sin \alpha_0)\,{\bf q},\label{e24w}\\[0.5ex]
{\bf z} &= \cos L\,\cos \alpha_0\,{\bf v} + (\sin L\,\sin\epsilon + \cos L\,\cos\epsilon\,\sin \alpha_0)\,{\bf s}\nonumber\\[0.5ex]
&\phantom{=} + (\sin L\,\cos\epsilon-\cos L\,\sin\epsilon\,\sin \alpha_0)\,{\bf q}.\label{e26w}
\end{align}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-9.eps}}
...
zenith at this latitude---lies at $L=+23^\circ 26'$. Incidentally, the word ``tropic'' derives from the Greek  τροπή, meaning a turn or change in direction.
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-10.eps}}
...
is $$180^\circ +2\,\sin ^{-1}(\tan L\,\tan\epsilon)$$
 time-degrees. Likewise, the
...
Incidentally, the word  ``clime", meaning a region defined by its weather, comes from the Greek κλίμα, meaning slope of inclination. Of course, the inclination in question is
the inclination of the Sun's rays to the vertical at a given location on the Earth. 
...
equator. Moreover, $\lambda$ is the ecliptic longitude of the point in question, and $L$ the terrestrial latitude of the observation
site. 
...
follows from Equation~(\ref{e43}) that 
$$A= \cos^{-1}[\sin (338^\circ)\,\sin (23^\circ 26')/\cos (60^\circ)] = 107^\circ 20'.$$ We conclude  that the
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-11.eps}}
...
\begin{figure}
\centerline{\includegraphics[height=2.25in]{Fig2-12.eps}}
...
&\phantom{=} -\sin A\left[\cos L\,\cos\epsilon + \sin L\,\sin\epsilon\,\sin(\alpha-t)\right].
\end{align}
...
&&&&&
$16^\circ 15'$  & $+01^\circ 26'$ &  $+2.9$ &  $\pi$      SGR\\
\multicolumn{8}{c}{}\\
...
\vspace{0.25cm}
\centering
{\scriptsize\begin{tabular}{cc|cc|cc|cc|cc|cc}
...
\begin{Parallel}{}{} 
\ParallelLText{
{\scriptsize\begin{tabular}{l|lll}
