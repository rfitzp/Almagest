\chapter[Planetary orbit models]{Geometric planetary orbit models}\label{ckep}
...
to the circle $\Pi P D A$, where $\Pi$ is the perihelion point, $P$ the planet's instantaneous position,
...
\begin{figure}[h]
\centerline{\includegraphics[height=2.5in]{Fig4-2.eps}}
...
\end{equation}
Now, $T = M + q$, where $q$ is angle $PSL$. However,
\begin{align}\label{e4.31x}
\sin q &= \frac{PL}{SP}\nonumber\\[0.5ex]
& = \frac{2\,e\,\sin M}{[1-2\,e\,\cos M\,(1-e^2\,\sin^2 M)^{1/2}+e^2+2\,e^2\,\sin^2 M]^{1/2}}.
\end{align}
...
\begin{figure}[h]
\centerline{\includegraphics[height=2.5in]{Fig4-4.eps}}
