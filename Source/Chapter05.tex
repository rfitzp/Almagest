...
\begin{figure}[h]
\centerline{\includegraphics[height=2.5in]{Fig5-1.eps}}
...
\lambda &= \bar{\lambda}  + q.
\end{align}
 These formulae are capable of matching NASA ephemeris data\,\footnote{See {http://ssd.jpl.nasa.gov/}}
...
$$t-t_0 = 2\,453\,495.5-2\,451\,545.0=1\,950.5~{\rm JD}.$$ 
Making use of
...
$$
 t-t_0 = 2\,378\,854.5-2\,451\,545.0=-72\,690.5~{\rm JD}.
 $$ Making use of
Table~\ref{lt5}, we find:
\begin{center}
\begin{tabular}{rrr}
...
\begin{figure}[t]
\centerline{\includegraphics[height=2.5in]{Fig5-2.eps}}
...
time period 1800 AD to 2050 AD. Source: Jet Propulsion Laboratory (NASA), {http://ssd.jpl.nasa.gov/}.  The motion rates have been converted into tropical motion rates assuming a uniform precession of the equinoxes
...
\vspace{0.25cm}
\centering
{\scriptsize \begin{tabular}{cr|cr|cr|cr|cr|cr}
