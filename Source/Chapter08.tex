...
\section{Planetary ecliptic longitude model}
Figure~\ref{vf7} compares and contrasts heliocentric and geocentric
models of the
motion  of a superior planet (that is, a planet that is farther from the
...
Because ${\bf P}'$ is also the displacement of the planet, $P$, from the
...
\begin{figure}[h]
\centerline{\includegraphics[height=2.in]{Fig8-1.eps}}
\caption{Heliocentric and geocentric models of the motion of a superior planet. Here, $S$ is the Sun, $G$ the Earth, and $P$ the planet.  The view is from the northern ecliptic pole.}\label{vf7}   
\end{figure}
 
\begin{figure}
\centerline{\includegraphics[height=2.5in]{Fig8-2.eps}}
\caption{Planetary longitude model. View is from northern ecliptic pole. }\label{vf4}
\end{figure}
...
and $T$ denote the geometric center, apocenter (that is, the point of
farthest distance from the central object), pericenter (that is, the
...
\begin{figure}[h]
\centerline{\includegraphics[height=2.in]{Fig8-3.eps}}
\caption{The triangle $GBP$.}\label{vf5xx}
\end{figure}

Let the line $GG'$ be produced, and let the perpendicular $PB$ be
dropped to it from $P$, as shown in Figure~\ref{vf5xx}. The angle $\mu\equiv PG'B$
is termed the {\em epicyclic anomaly}\/ (see Figures~\ref{vf5x}), and takes the form
\begin{equation}
...
epicycle. See Chapter~\ref{csun}. The epicyclic anomaly is generally written in the 
...
Finally, the ecliptic longitude of the planet is given by  (see Figure~\ref{vf5x})
\begin{equation}
...
such a function directly. Fortunately, while $\theta(\mu,z)$
...
\end{align}
and
\begin{align}\label{ve52}
\Theta_-(\xi) &= - (1/2)\,\xi\,(\xi-1),\\[0.5ex]
\Theta_+(\xi) &=+ (1/2)\,\xi\,(\xi+1).\label{ve53}
\end{align}
This scheme allows us to avoid having to tabulate a
two-dimensional function, while ensuring that the exact value of $\theta(\mu,z)$ is obtained
when $z=\bar{z}$, $z_{\rm min}$, or $z_{\rm max}$. The previous interpolation
scheme is very similar to that adopted by Ptolemy in the Almagest.

Our procedure for determining the ecliptic longitude of a superior planet is described in the following. It is assumed that the ecliptic longitude, $\lambda_S$, and the
...
Earth is unity. The requisite elements for all of the superior planets at the J2000 epoch ($t_0=2\,451\,545.0$ JD)
...
\section{Determination of the ecliptic longitude of Mars}
...
\end{enumerate}
Two examples of this procedure are given in the following section

\section{Example martian ecliptic longitude calculations}
\begin{center}
{\em Example 1}: May 5, 2005 AD, 00:00 UT
\end{center}
From Section~\ref{ssun}, $t-t_0=1\,950.5$ JD, $\lambda_S= 44.602^\circ$, $M_S\simeq 120^\circ$. Hence, it follows from Table~\ref{lt6} that
...
114^\circ,
$$
where we have rounded the epicyclic anomaly to the nearest degree. It follows from Table~\ref{vt10}
that 
$$
...
so
\begin{align*}
\theta & = \Theta_-\,\delta\theta_- + \bar{\theta}+\Theta_+\,\delta\theta_+ \\[0.5ex]
&= 0.101\times 3.853+39.209+0.619\times 4.612 \\[0.5ex]
&= 42.453^\circ.
\end{align*}
Finally,
$$
...
$$
Thus,
the ecliptic longitude of Mars at 00:00 UT on May 5, 2005 AD was 2PI46.

\begin{center}
\noindent {\em Example 2}: December 25, 1800 AD, 00:00 UT
\end{center}
From Section~\ref{ssun}, $t-t_0=-72,690.5$ JD, $\lambda_S= 273.055^\circ$, $M_S\simeq 354^\circ$. Hence, it follows from Table~\ref{lt6} that
...
\begin{align*}
\theta & = \Theta_-\,\delta\theta_- + \bar{\theta}+\Theta_+\,\delta\theta_+ \\[0.5ex]
&= -0.113\times 5.980-32.007-0.077\times 8.955 \\[0.5ex]
&= -30.642^\circ.
\end{align*}
Finally,
$$
...
$$ 
Thus,
the ecliptic longitude of Mars at 00:00 UT on December 25, 1800 AD was 10TA34.

\begin{figure}[h]
\centerline{\includegraphics[height=2.5in]{Fig8-4.eps}}
\caption{The geocentric orbit of a superior planet. Here, $G$, $G'$, $P$,  $\mu$,  $\theta$, $\bar{\lambda}$, $q$, and $\Upsilon$ represent
the Earth, guide-point, planet,  epicyclic anomaly, equation of the epicycle, mean longitude, equation of center, and spring equinox, respectively. The view is
from northern ecliptic pole. Both $G'$ and $P$ orbit counterclockwise.}\label{vf5x}
\end{figure}

\section{Conjunction, opposition, and station dates}
Figure~\ref{vf5x} shows the geocentric orbit of a superior planet. Recall that the vector $G'P$ is always parallel to the vector connecting the Earth to the Sun. It follows that
...
a conjunction, the planet is farthest from the Earth, and has the same ecliptic longitude as the
...
it appears to stand still in the sky (relative to the fixed stars) for a few days while it reverses direction.

Tables~\ref{vt8}--\ref{vt10} can be used to determine the dates of the conjunctions, oppositions, and
stations of Mars. Consider the first conjunction after the epoch (January 1, 2000 AD). We can estimate the
time at which this event occurs by approximating the epicyclic anomaly as the so-called
{\em mean epicyclic anomaly}: 
\begin{align*}
\mu \simeq \bar{\mu} &= \bar{\lambda}_S-\bar{\lambda} = \bar{\lambda}_{0\,S}-\bar{\lambda}_0 +(n_S-n)\,(t-t_0)\\[0.5ex]
& = 284.998 + 0.46157617\,(t-t_0).
\end{align*}
 We obtain
$$
...
$$
which corresponds to July 1, 2000 AD.
...
June 13, 2001 AD. Incidentally, it is clear from the previous analysis that the
mean  time period between successive conjunctions,  or  oppositions, of Mars is $$360/0.46157617= 779.9\, {\rm JD},$$ which is
...
\end{equation}
Now, a station corresponds to $d\lambda/dt = 0$ (that is, a local maximum or minimum of $\lambda$), which gives
\begin{equation}
...
stations of Mars for the years 2000--2020 AD, calculated using the
previously described techniques.

\section{Determination of ecliptic longitude of Jupiter}
...
\begin{center}
{\em Example}: May 5,  2005 AD, 00:00 UT
\end{center}
...
208^\circ,
$$
where we have rounded the epicyclic anomaly to the nearest degree. It follows from Table~\ref{vt13}
that 
$$
...
\begin{align*}
\theta  &= \Theta_-\,\delta\theta_- + \bar{\theta}+\Theta_+\,\delta\theta_+ \\[0.5ex]
&= 0.469\times 0.447-6.194+0.121\times 0.522\\[0.5ex]
& =- 5.921^\circ.
\end{align*}
Finally,
$$
...
$$
Thus,
the ecliptic longitude of Jupiter at 00:00 UT on May 5, 2005 AD was 10LI29.
...
during the years 2000--2010 AD are shown in Table~\ref{vtjupiter}.

\section{Determination of ecliptic longitude of Saturn}
...
287^\circ,
$$
where we have rounded the epicyclic anomaly to the nearest degree. It follows from Table~\ref{vt16}
that 
$$
...
\begin{align*}
\theta  &= \Theta_-\,\delta\theta_- + \bar{\theta}+\Theta_+\,\delta\theta_+\\[0.5ex]
& = -0.071\times 0.353-5.551-0.759\times 0.405\\[0.5ex]
& =- 5.883^\circ.
\end{align*}
Finally,
$$
...
$$
Thus,
the ecliptic longitude of Saturn at 00:00 UT on May 5, 2005 AD was 22CN06.
...
during the years 2000--2010 AD are shown in Table~\ref{vtsaturn}.

Incidentally, the information contained in the mean motion tables, \ref{vt8}, \ref{vt11}, and \ref{vt14}, as well as the deferential anomaly tables, \ref{vt9}, \ref{vt12}, and \ref{vt15}, is essentially equivalent to that contained in 
the ``Tables of the mean longitudinal motion and anomalies of the five stars" (Κανόνες μέσων κινήσεων μήκους τε καὶ ἀνωμαλίας τῶν πέντε ἀστέρων)
that appear in Section~4 of Book~IX of the Almagest. Likewise, the information contained in the epicyclic anomaly tables, \ref{vt10}, \ref{vt13}, and \ref{vt16}, is equivalent
to that contained in the ``Tables of the longitudinal corrections of the five planets" (Κανόνες τῆς κατὰ μῆκος τῶν πέντε πλανωμένων διευκρινήσεως) that appear in Section~11 of Book~XI of the Almagest. The computation of the stations of the superior planets is
...
\end{tabular}
\caption{Constants associated with the epicycles of the inferior and superior planets.}\label{vtx}
\end{table}
...
\end{tabular}
\caption{Epicyclic interpolation coefficients. Note that $\Theta_\pm (\xi) = - \Theta_\mp (-\xi)$.}\label{vty}
\end{table}
...
\end{tabular}
\caption{ Mean motion of Mars.  Here, $\Delta t = t-t_0$, $\Delta\bar{\lambda} = \bar{\lambda}-\bar{\lambda}_0$, $\Delta M = M - M_0$,
...
\end{tabular}}
\caption{Deferential anomalies of Mars.}\label{vt9}
\end{table}
...
\end{tabular}}
\caption{Epicyclic anomalies of Mars. All quantities are in degrees. Note that $\bar{\theta}(360^\circ-\mu) = -\bar{\theta}(\mu)$, and $\delta\theta_{\pm}(360^\circ-\mu) = -\delta\theta_{\pm}(\mu)$. }\label{vt10}
\end{table}
...
Event & Date & $\lambda$ & Event & Date & $\lambda$  \\\hline
&&\\[-1.75ex]
Conjunction & 01/07/2000 & 10CN13 &Conjunction & 04/02/2011 & 15AQ42\\
Station (R) & 12/05/2001 & 29SG00 & Station (R) & 24/01/2012 & 23VI01\\
Opposition & 13/06/2001 & 22SG44 & Opposition & 03/03/2012 & 13VI42\\
Station (D) & 19/07/2001 & 15SG02 & Station (D) & 14/04/2012 & 03VI51\\
Conjunction & 10/08/2002 & 18LE05 & Conjunction & 17/04/2013 & 28AR06\\
Station (R) & 29/07/2003 & 10PI20 & Station (R) & 01/03/2014 & 27LI31\\
Opposition & 28/08/2003 & 05PI03 & Opposition & 08/04/2014 & 19LI00\\
Station (D) & 27/09/2003 & 29AQ55 & Station (D) & 20/05/2014 & 09LI04\\
Conjunction & 15/09/2004 & 23VI06 & Conjunction & 14/06/2015 & 23GE28\\
Station (R) & 02/10/2005 & 23TA31 & Station (R) & 17/04/2016 & 08SG45\\
Opposition & 07/11/2005 & 15TA06 & Opposition & 22/05/2016 & 01SG43\\
Station (D) & 09/12/2005 & 08TA24 & Station (D) & 29/06/2016 & 22SC55\\
Conjunction & 23/10/2006 & 29LI44 & Conjunction & 27/07/2017 & 04LE11\\
Station (R) & 15/11/2007 & 12CN36 & Station (R) & 27/06/2018 & 09AQ35\\
Opposition & 24/12/2007 & 02CN45 & Opposition & 27/07/2018 & 04AQ22\\
Station (D) & 31/01/2008 & 24GE15 & Station (D) & 27/08/2018 & 28CP43\\
Conjunction & 05/12/2008 & 14SG08 & Conjunction & 02/09/2019 & 09VI43\\
Station (R) & 20/12/2009 & 19LE35 & Station (R) & 10/09/2020 & 28AR08\\
Opposition & 29/01/2010 & 09LE45 & Opposition & 13/10/2020 & 20AR59\\
Station (D) & 10/03/2010 & 00LE20& Station (D) & 13/11/2020 & 15AR05\\
\end{tabular}
\caption{The conjunctions, oppositions, and stations of Mars
during the years 2000--2020 AD. (R) indicates a retrograde station, and (D)
...
\end{tabular}
\caption{Mean motion of Jupiter.  Here, $\Delta t = t-t_0$, $\Delta\bar{\lambda} = \bar{\lambda}-\bar{\lambda}_0$, $\Delta M = M - M_0$, and $\Delta\bar{F} = \bar{F} - \bar{F}_0$. At epoch  ($t_0 = 2\,451\,545.0$ JD), $\bar{\lambda}_0 = 34.365^\circ$,  $M_0 = 19.348^\circ$, and $\bar{F}_0=293.660^\circ$. }\label{vt11}
\end{table}
...
\end{tabular}}
\caption{Deferential anomalies of Jupiter.}\label{vt12}
\end{table}
...
\end{tabular}}
\caption{Epicyclic anomalies of Jupiter. All quantities are in degrees. Note that $\bar{\theta}(360^\circ-\mu) = -\bar{\theta}(\mu)$, and $\delta\theta_{\pm}(360^\circ-\mu) = -\delta\theta_{\pm}(\mu)$. }\label{vt13}
\end{table}
...
Event & Date & $\lambda$ & Event & Date & $\lambda$\\\hline
&&\\[-1.75ex]
Conjunction & 08/05/2000 & 17TA53  &Conjunction & 22/10/2005 & 29LI16\\
Station (R) & 29/09/2000 & 11GE13 &Station (R) & 04/03/2006 & 18SC54\\
Opposition & 28/11/2000 & 06GE08 &Opposition & 04/05/2006 & 14SC03\\
Station (D) & 25/01/2001 & 01GE10 &Station (D) & 06/07/2006 & 09SC02\\
Conjunction & 14/06/2001 & 23GE30 &Conjunction & 22/11/2006 & 29SC34\\
Station (R) & 02/11/2001 & 15CN41 &Station (R) & 06/04/2007 & 19SG49\\
Opposition & 01/01/2002 & 10CN37 &Opposition & 06/06/2007 & 14SG57\\
Station (D) & 01/03/2002 & 05CN37 &Station (D) & 07/08/2007 & 09SG58\\
Conjunction & 20/07/2002 & 27CN11&Conjunction & 23/12/2007 & 01CP03\\
Station (R) & 04/12/2002 & 18LE06 &Station (R) & 09/05/2008 & 22CP23\\
Opposition & 02/02/2003 & 13LE06 &Opposition & 09/07/2008 & 17CP30\\
Station (D) & 04/04/2003 & 08LE03 &Station (D) & 08/09/2008 & 12CP33\\
Conjunction & 22/08/2003 & 28LE55 &Conjunction & 24/01/2009 & 04AQ23\\
Station (R) & 04/01/2004 & 18VI54 &Station (R) & 15/06/2009 & 27AQ01\\
Opposition & 04/03/2004 & 13VI58 &Opposition & 14/08/2009 & 22AQ04\\
Station (D) & 05/05/2004 & 08VI55 &Station (D) & 13/10/2009 & 17AQ10\\
Conjunction & 22/09/2004 & 29VI21&Conjunction & 28/02/2010 & 09PI43\\
Station (R) & 02/02/2005 & 18LI53 &Station (R) & 23/07/2010 & 03AR20\\
Opposition & 03/04/2005 & 14LI00& Opposition & 21/09/2010 & 28PI19\\
Station (D) & 05/06/2005 & 08LI58&Station (D) & 18/11/2010 & 23PI26\\
\end{tabular}}
\caption{The conjunctions, oppositions, and stations of Jupiter
during the years 2000--2010 AD. (R) indicates a retrograde station, and (D)
...
\end{tabular}
\caption{Mean motion of Saturn.  Here, $\Delta t = t-t_0$, $\Delta\bar{\lambda} = \bar{\lambda}-\bar{\lambda}_0$,  $\Delta M = M - M_0$, and $\Delta\bar{F} = \bar{F} - \bar{F}_0$.  At epoch  ($t_0 = 2\,451\,545.0$ JD), $\bar{\lambda}_0 = 50.059^\circ$,  $M_0 = 317.857^\circ$, and
...
\end{tabular}}
\caption{Deferential anomalies of Saturn.}\label{vt15}
\end{table}
...
\end{tabular}}
\caption{Epicyclic anomalies of Saturn. All quantities are in degrees. Note that $\bar{\theta}(360^\circ-\mu) = -\bar{\theta}(\mu)$, and $\delta\theta_{\pm}(360^\circ-\mu) = -\delta\theta_{\pm}(\mu)$. }\label{vt16}
\end{table}
...
Event & Date &$\lambda$ & Event & Date &$\lambda$ \\\hline
&&\\[-1.75ex]
Conjunction & 10/05/2000 & 20TA26 &Station (R) & 22/11/2005 & 11LE19\\
Station (R) & 12/09/2000 & 00GE59 &Opposition & 27/01/2006 & 07LE51\\
Opposition & 19/11/2000 & 27TA29&Station (D) & 05/04/2006 & 04LE22\\
Station (D) & 24/01/2001 & 24TA03&Conjunction & 07/08/2006 & 14LE51\\
Conjunction & 25/05/2001 & 04GE22&Station (R) & 06/12/2006 & 25LE04\\
Station (R) & 26/09/2001 & 14GE59&Opposition & 10/02/2007 & 21LE38\\
Opposition & 03/12/2001 & 11GE29&Station (D) & 19/04/2007 & 18LE09\\
Station (D) & 08/02/2002 & 08GE02&Conjunction & 22/08/2007 & 28LE32\\
Conjunction & 09/06/2002 & 18GE28&Station (R) & 19/12/2007 & 08VI34\\
Station (R) & 11/10/2002 & 29GE06&Opposition & 24/02/2008 & 05VI10\\
Opposition & 17/12/2002 & 25GE36&Station (D) & 03/05/2008 & 01VI41\\
Station (D) & 22/02/2003 & 22GE08&Conjunction & 04/09/2008 & 11VI56\\
Conjunction & 24/06/2003 & 02CN39&Station (R) & 31/12/2008 & 21VI46\\
Station (R) & 25/10/2003 & 13CN15&Opposition & 08/03/2009 & 18VI23\\
Opposition & 31/12/2003 & 09CN46&Station (D) & 17/05/2009 & 14VI56\\
Station (D) & 07/03/2004 & 06CN17&Conjunction & 17/09/2009 & 25VI01\\
Conjunction & 08/07/2004 & 16CN50&Station (R) & 13/01/2010 & 04LI40\\
Opposition & 22/03/2010 & 01LI18&Station (R) & 08/11/2004 & 27CN21\\
Opposition & 13/01/2005 & 23CN52&Station (D) & 30/05/2010 & 27VI51\\
Station (D) & 22/03/2005 & 20CN23&Conjunction & 01/10/2010 & 07LI46\\
Conjunction & 23/07/2005 & 00LE56&&\\
\end{tabular}}
\caption{The conjunctions, oppositions, and stations of Saturn
during the years 2000--2010 AD. (R) indicates a retrograde station, and (D)
