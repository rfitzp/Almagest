...
\item $a_M$: major radius of Moon's orbit.
\item $a_S$: major radius of Sun's orbit.
...
\item $e$: eccentricity.
\item $e_M$: eccentricity of Moon's orbit.
\item $e_S$: eccentricity of Sun's orbit.
\item $\epsilon$: inclination of ecliptic to celestial equator.
\item $E$: elliptic anomaly.
\item $\zeta$: radial anomaly. 
\item $\zeta_i$: lunar radial anomalies. 
...
\item $q_i$: lunar longitudinal anomalies.
