...
Figures~\ref{map1} and \ref{map2}  and   Table~\ref{tstar}  contain more or less the same information that is contained in Section~5 of Book VII of the Almagest
...
Τοξότης (Archer), Αἰγόκερως (Goat-horned), Ὑδροχόος (Water-pourer), and  Ἰχθύες  (Fish). The familiar names listed in the previous table are
...
as is contained in the ``Table of inclinations" (Κανόνιoν λοξώσεως) that appears in Section~15 of Book~I of the Almagest. The slight difference between the values appearing in our
