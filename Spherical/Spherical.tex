...
\caption{The celestial sphere. Here, $G$, $P$, $P'$, $V$, and $V'$ represent the Earth, north celestial
pole, south celestial pole, vernal equinox, and  autumnal equinox, respectively. Moreover, $VUV'U'$ is the celestial equator, and $PP'$ the
...
within $15^\circ$ of the ecliptic. Table~\ref{tstar} gives the ecliptic longitudes (relative to the start of the zodiacal sign---see next section), ecliptic latitudes, and
...
complimentary point to 14LE00 is 14AQ00. It follows that
 ...
 solar, hour. A sidereal hour is $1/24$th of a sidereal day,
