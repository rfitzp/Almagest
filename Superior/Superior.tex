...
models of the
motion  of a superior planet (that is, a planet which is further from the
...
furthest distance from the central object), pericenter (that is, the
...
Incidentally, the information contained in the mean motion tables, \ref{vt8}, \ref{vt11}, and \ref{vt14}, is essentially equivalent to that contained in the tables
that appear in Section~4 of Book~IX of the Almagest. Likewise, the information contained in the anomaly tables, \ref{vt9}, \ref{vt13}, and \ref{vt15}, is equivalent
to that contained in the tables that appear in Section~11 of Book~XI of the Almagest. The computation of the stations of the superior planets is
